...
import logo from "../../assets/imgs/HOBBITON.png";
import logoSm from "../../assets/imgs/HOBBITON-sm.png";
...
function AgentMtpMenu({ largeContentClass, minimiseMenu, maximiseMenu }) {
    ...
    <div className="menuSide">
      ...
      {toggleMenu === true ? (
        <nav className="sidebar">
          <div id="brand">
            <img width={150} src={logo} alt="HOBBITON" />
            <div
              id="arrowCircle"
              onClick={() => {
                hideToggleMenu();
